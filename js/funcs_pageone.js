...
//    //alert('in get details');//to be removed
	...
	var finurl= getQueryStringForGet(server_url,tempprod.pdId);
...
function getQueryStringForGet (url,pid)
{	
